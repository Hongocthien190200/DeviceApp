...
function DeviceModal({ setIsNotiSucces, setIsModalOpen, handleCloseModal, statuses, categories, locations, getAllDevice, user, axiosJWT, departments, units }) {
    ...
    const validateForm = () => {
        ...
        if (!newDeviceData.quantity) {
            errors.quantity = 'Bạn vui lòng không để trống trường này';
            hasErrors = true;
        }
                    ...
                    <form>
                        ...
                        <div className={cx('input-group')}>
                            ...
                            <input
                                type="text"
                                name="quantity"
                                value={newDeviceData.quantity}
                                onChange={handleInputChange}
                            />
                            <div className={cx('error-message')}>{formErrors.quantity}</div>
                        </div>
